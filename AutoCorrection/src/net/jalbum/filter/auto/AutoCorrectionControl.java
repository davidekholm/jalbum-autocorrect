...
import net.jalbum.filter.auto.util.FilterControl;
import java.awt.event.ActionEvent;
import java.awt.event.ActionListener;
import javax.swing.JCheckBox;
import javax.swing.JPanel;
import se.datadosen.jalbum.Msg;
import net.jalbum.filter.auto.util.ExtendedSlider;
...
//    private ExtendedSlider intensity = new ExtendedSlider(0, 5, 5);
...
//        intensity.removeResetButton();
//        intensity.setSliderWidth(FilterControl.SLIDER_WIDTH);
//        intensity.addActionListener(new ActionListener() {
//
//            public void actionPerformed(ActionEvent e) {
//                autoCorrPlugin.setIntensity(intensity.getValue());
//                autoCorrPlugin.renderImage();
//            }
//        });
//        
