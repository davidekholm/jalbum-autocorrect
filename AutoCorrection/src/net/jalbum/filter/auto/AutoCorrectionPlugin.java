package net.jalbum.filter.auto;

import java.util.Map;
import net.jalbum.filter.auto.util.BasicFilter;
 ...
 */
public class AutoCorrectionPlugin extends BasicFilter implements JAFilter {
    ...
    private final int INTENSITY_CHANGE = 5;
    ...
    private void autoContrast() {
        ...
        double intensitySpec = 255.0 - ((INTENSITY_CHANGE-intensity)*INTENSITY_CHANGE);
        double contrast = intensitySpec / (max - min);
    ...
    public void setColorsPossible(boolean colorsPossible) {
        this.colorsPossible = colorsPossible;
    }
